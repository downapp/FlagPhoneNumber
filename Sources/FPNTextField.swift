...
open class FPNTextField: UITextField, FPNCountryPickerDelegate, FPNDelegate {
    ...
    private func setupFlagButton() {
        ...
        flagButton.addTarget(self, action: #selector(showSearchController), for: .touchUpInside)
    ...
    private func setUpRightView() {
        ...
        rightView?.addSubview(rightArrow())
    }
    
    private func rightArrow() -> UILabel {
...
//            let navigationViewController = UINavigationController(rootViewController: searchCountryViewController)
            ...
            parentViewController?.navigationController?.pushViewController(searchCountryViewController, animated: true)
